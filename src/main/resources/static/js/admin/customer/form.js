layui.define(['layer','form','common','laydate'], function (exports) {
    ...
    var datalist = {
        ...
        editData: function (id) {
            common.frame_show('编辑','/admin/customer/form?id='+id,$(window).width(),$(window).height());
        }
    };
            ...
            success: function(ret){
                ...
                if(ret.isOk){
                    layer.msg("操作成功", {time: 2000},function(){
                        ...
                        window.parent.location.href="/admin/customer/index";
                    });
                }else{
                    layer.msg(ret.msg, {time: 2000});
                }
    ...
    form.on('submit(import)', function(data){
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "/admin/customer/excelImport",
            data: data.field,
            success: function(ret){
                console.log(ret);
                if(ret.isOk){
    ...
    exports('admin/customer/form', datalist);
})
