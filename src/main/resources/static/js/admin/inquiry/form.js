layui.define(['layer','form','common','laydate'], function (exports) {
    ...
    var datalist = {
        ...
        editData: function (id) {
            common.frame_show('编辑','/admin/inquiry/form?id='+id,$(window).width(),$(window).height());
        }
    };
            ...
            success: function(ret){
                ...
                if(ret.isOk){
                    layer.msg("操作成功", {time: 2000},function(){
                        ...
                        window.parent.location.href="/admin/inquiry/index";
                    });
                }else{
                    layer.msg(ret.msg, {time: 2000});
                }
    ...
    exports('admin/inquiry/form', datalist);
})
