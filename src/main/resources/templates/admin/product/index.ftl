...
<fieldset id="dataList" class="layui-elem-field layui-field-title sys-list-field">
    ...
    <div class="layui-row">
        <div class="layui-form layui-col-md12 star-so">
            <input class="layui-input" placeholder="请输入SKU 或 OE 或 车品牌 或 车型 或 产品名称" name="keyword" id="keyword">
            <button class="layui-btn" id="search" ">精确搜索</button>
    ...
    <div style="padding: 40px 0px 0px 80px;">
        <div class="layui-inline">
            <div class="layui-input-inline" style="width:auto">
                ...
                <a id="importproduct" class="layui-btn layui-btn-normal">导入</a>
                <a id="outproduct" class="layui-btn layui-btn-normal">导出</a>
            </div>
        </div>
    </div>
